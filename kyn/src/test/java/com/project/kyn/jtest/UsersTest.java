...
public class UsersTest {
	...
	public void testUserRegister() throws Exception {
		...
		Users newUser = new Users(1,"test123","test123@", "tester", "tesa", "test@gmail.com");
		...
		.andExpect(MockMvcResultMatchers.jsonPath("$.firstName").value("tester"));
